...
export function NewNoteCard({ onNoteCreated }: newNoteCardProps) {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger onClick={() => {setShouldShowOnBoarding(true)}} className="rounded-md bg-slate-700 p-5 gap3 flex flex-col text-left hover:ring-2 outline-none hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
